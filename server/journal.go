...
// map exists purely for THIS server's own HTTP claim/eviction residency, an
// orthogonal concept from "does anything in this process hold a live
...
// synchronously, before the child's turn ever starts, and — for a child
// this process merely rediscovers (a follow-up touch after Reap, or after
// a restart) — ReportTurnStart/handleSpawnChild's own AdoptReloaded fallback
...
// ReportTurnStart's "always re-attach to the LIVE object" doc comment), so
